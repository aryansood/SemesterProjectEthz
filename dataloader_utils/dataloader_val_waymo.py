...
class WaymoE2EDatasetVal(Dataset):
    def __init__(self, data_path, seq_len):
        ...
        self.list_val_rater = np.load('val_rater_score_pos.npy')
    ...
    def __getitem__(self, index):
        ...
        front_image_list, rear_image_list, next_state_traj, past_state_traj, drving_intent = return_objects(index_to_start-self.seq_len+1, index_to_start+1, file_data_path, file_data_names)
